...
WebUI.click(findTestObject('Object Repository/Page_WEP Home DeBeers/Page_WEP  Home/td_Test notif'))

WebUI.click(findTestObject('Object Repository/Page_WEP Home DeBeers/Page_WEP  Home/button_APPROVE'))

WebUI.setText(findTestObject('Object Repository/Page_WEP Home DeBeers/Page_WEP  Home/input_Upper cost limit_uppercost'), 
    '550')

WebUI.setText(findTestObject('Object Repository/Page_WEP Home DeBeers/Page_WEP  Home/textarea_Comments_comments'), 'Approved by supervisor')

WebUI.click(findTestObject('Object Repository/Page_WEP Home DeBeers/Page_WEP  Home/button_SUBMIT'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_WEP Home DeBeers/Page_WEP  Home/span_Successfully approved'), 
