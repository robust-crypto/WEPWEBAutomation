...
WebUI.click(findTestObject('Object Repository/Page_WEP  Home/td_Equipment Failure'))

WebUI.click(findTestObject('Object Repository/Page_WEP  Home/label_Equipment Failure'))

WebUI.click(findTestObject('Object Repository/Page_WEP  Home/button_EDIT'))

WebUI.setText(findTestObject('Object Repository/Page_WEP  Home/input_Description_w-100 form-control round _01bf87'), 'Equipment Failure edited automation')

WebUI.click(findTestObject('Object Repository/Page_WEP  Home/button_SAVE'))

WebUI.click(findTestObject('Object Repository/Page_WEP  Home/img'))
