...
WebUI.verifyElementText(findTestObject('Page_WEP  Work Requests/Successfully approved1'), ' Aprobado Exitosamente')

WebUI.verifyElementText(findTestObject('Page_WEP  Work Requests/Successfully approved2'), 'Aprobado Exitosamente')

WebUI.verifyElementText(findTestObject('Page_WEP  Work Requests/Successfully approved3'), 'Aprobado Exitosamente')

WebUI.verifyElementText(findTestObject('Page_WEP  Work Requests/Successfully approved4'), 'Aprobado Exitosamente')
