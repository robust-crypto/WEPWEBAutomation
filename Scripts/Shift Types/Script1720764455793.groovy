...
WebUI.verifyElementPresent(findTestObject('Page_Anglo ChecklistPreprod/Page_Anglo Checklists  Checklist/a_Shift Types'), 
    0)

WebUI.verifyElementClickable(findTestObject('Page_Anglo ChecklistPreprod/Page_Anglo Checklists  Checklist/a_Shift Types'))

WebUI.click(findTestObject('Page_Anglo ChecklistPreprod/Page_Anglo Checklists  Checklist/a_Shift Types'))
...
WebUI.setText(findTestObject('Page_Anglo ChecklistPreprod/Page_Anglo Checklists  Checklist/input_Description_Description'), 
    'AAT (Automated Shift Type)')

WebUI.click(findTestObject('Page_Anglo ChecklistPreprod/Page_Anglo Checklists  Checklist/button_Save'))

WebUI.verifyElementPresent(findTestObject('Page_Anglo ChecklistPreprod/Page_Anglo Checklists  Checklist/div_Shift type updated successfully'), 
    0)
...
WebUI.click(findTestObject('Page_Anglo ChecklistPreprod/Page_Anglo Checklists  Checklist/input_Amandelbult_IsActive'))
...
WebUI.verifyElementPresent(findTestObject('Page_Anglo ChecklistPreprod/Page_Anglo Checklists  Checklist/div_Shift type removed successfully'), 
    0)
