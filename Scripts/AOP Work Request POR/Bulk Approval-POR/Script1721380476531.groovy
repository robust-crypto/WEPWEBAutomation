...
WebUI.verifyElementText(findTestObject('Page_WEP  Work Requests/Successfully approved1'), 'Aprovado com sucesso')

WebUI.verifyElementText(findTestObject('Page_WEP  Work Requests/Successfully approved2'), 'Aprovado com sucesso')

WebUI.verifyElementText(findTestObject('Page_WEP  Work Requests/Successfully approved3'), 'Aprovado com sucesso')

WebUI.verifyElementText(findTestObject('Page_WEP  Work Requests/Successfully approved4'), 'Aprovado com sucesso')
