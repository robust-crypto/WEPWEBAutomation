...
WebUI.verifyElementText(findTestObject('Page_WEP  Work Requests/Successfully Rejected1'), '\tReprovado com sucesso')

WebUI.verifyElementText(findTestObject('Page_WEP  Work Requests/Successfully Rejected2'), '\tReprovado com sucesso')

WebUI.verifyElementText(findTestObject('Page_WEP  Work Requests/Successfully Rejected3'), '\tReprovado com sucesso')

WebUI.verifyElementText(findTestObject('Page_WEP  Work Requests/Successfully Rejected4'), '\tReprovado com sucesso')
