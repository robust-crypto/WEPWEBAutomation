...
for (int i = 0; i < 3; i++) {
    ...
    switch (i) {
        case 0:
            WebUI.setText(findTestObject('Object Repository/Page_WEP Home DeBeers/textarea_Description_descriptionimage'), 
                'Maintenance DBRS Auto')

            break
        case 1:
            WebUI.setText(findTestObject('Object Repository/Page_WEP Home DeBeers/textarea_Description_descriptionimage'), 
                'Equipment Failure DBRS Auto ')

            break
        case 2:
            WebUI.setText(findTestObject('Object Repository/Page_WEP Home DeBeers/textarea_Description_descriptionimage'), 
                ' Activity Report DBRS Auto')
    ...
    WebUI.click(findTestObject('Page_WEP Home DeBeers/Page_WEP  Home/div_GKEST - MAIN G01 Electrical  Instrumentation MWC-new'))

    WebUI.click(findTestObject('Page_WEP Home DeBeers/Page_WEP  Home/div_Low  Low-low'))
